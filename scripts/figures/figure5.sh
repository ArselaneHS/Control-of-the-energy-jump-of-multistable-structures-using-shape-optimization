...
#############################################################################################
# Config 1 -> paper Fig. 5, top-right panel  (N=2, J_2) -> Figures_paper/ROL_NE3_2_J2.png
objective_params="{
    \"number of holes\": 2,
    \"radius\": 0.9, 
...
# Config 2 -> paper Fig. 5, top-left panel   (N=2, J_1) -> Figures_paper/ROL_NE3_2_J1.png
objective_params="{
    \"number of holes\": 2,
    \"radius\": 0.9, 
    \"top displacement\": 0.1,
...
# Config 3 -> paper Fig. 5, bottom-right panel (N=4, J_2) -> Figures_paper/ROL_NE3_4_J2.png
objective_params="{
    \"number of holes\": 4,
    \"radius\": 0.85, 
    \"top displacement\": 0.1,
...
# Config 4 -> paper Fig. 5, bottom-left panel  (N=4, J_1) -> Figures_paper/ROL_NE3_4_J1.png
objective_params="{
    \"number of holes\": 4,
    \"radius\": 0.85, 
    \"top displacement\": 0.1,
